...
export default function HomePage() {
  ...
  const services = [
    ...
    },
    {
      ...
      title: "Logo ERP Entegrasyonları",
      description: "Logo ERP sisteminizi modern AI çözümleriyle güçlendirin",
      features: [
        "Logo ERP Bağlantısı",
        "Stok Yönetimi",
          ...
          >
            ...
            <div className="bg-white/80 backdrop-blur-lg rounded-3xl p-8 shadow-lg border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed">
                Full-stack developer olarak Next.js, MongoDB, OpenAI, Logo ERP,
                n8n gibi teknolojilerle işletmelerin yapay zeka dönüşümüne
                öncülük ediyorum. MyBulut, PlutonAI gibi başarılı AI
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="logo-erp">Logo ERP Entegrasyon</option>
                  </select>
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">
